        ...
        <div class="container">
            ...
            <div class="row justify-content-center">
                <div class="col-md-12 login-form-2" style="padding: 5%" >
                    <form method="POST" action="{{ route('register',['is_become'=>true]) }}">
                        @csrf

                        <input name="become" type="hidden">
                        <div class="form-row mt-3">
                            ...
                            <div class="col-md-6 ">
                                ...
                                <small class="text-white">
                                    {{__('Se comprobará con tu email y contraseña si ya eres usuario')}}
                                </small>
                                @error('email')
